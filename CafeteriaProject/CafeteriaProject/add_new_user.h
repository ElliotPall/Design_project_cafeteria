...
namespace cafeteria_project {
	...
	#pragma region Windows Form Designer generated code
			...
			void InitializeComponent(void)
			{
				...
				//this->body_->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &NewUserForm::panel1_Paint);
				// 
				// header_
				// 
				...
				//this->header_->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &NewUserForm::HeaderPaintEvent);
				// 
				// icon_
				// 
				...
				//this->icon_->Click += gcnew System::EventHandler(this, &NewUserForm::IconOnClick);
				// 
				// title_
				// 
				...
				//this->title_->Click += gcnew System::EventHandler(this, &NewUserForm::TitleOnClick);
				// 
				// category_label_
				// 
				...
				//this->category_label_->Click += gcnew System::EventHandler(this, &NewUserForm::category_label__Click);
				// 
				// category_dropdown_
				// 
				...
				this->category_dropdown_->SelectedIndexChanged += gcnew System::EventHandler(this, &NewUserForm::CategoryDropdownSelectedIndexChanged);
				// 
				// name_label_
				// 
				...
				//this->name_label_->Click += gcnew System::EventHandler(this, &NewUserForm::label2_Click);
				// 
				// name_textbox_
				// 
				...
				this->name_textbox_->TextChanged += gcnew System::EventHandler(this, &NewUserForm::NameTextboxTextChanged);
				// 
				// gender_label_
				// 
				...
				//this->gender_label_->Click += gcnew System::EventHandler(this, &NewUserForm::label3_Click);
				// 
				// gender_dropdown_
				// 
				...
				this->gender_dropdown_->SelectedIndexChanged += gcnew System::EventHandler(this, &NewUserForm::GenderDropdownSelectedIndexChanged);
				// 
				// group_label_
				// 
				...
				//this->group_label_->Click += gcnew System::EventHandler(this, &NewUserForm::label4_Click);
				// 
				// group_dropdown_
				// 
				...
				this->group_dropdown_->SelectedIndexChanged += gcnew System::EventHandler(this, &NewUserForm::GroupDropdownSelectedIndexChanged);
				// 
				// ok_button_
				// 
				...
				this->ok_button_->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(224)), static_cast<System::Int32>(static_cast<System::Byte>(224)),
					static_cast<System::Int32>(static_cast<System::Byte>(224)));
				this->ok_button_->Location = System::Drawing::Point(130, 631);
				this->ok_button_->Name = L"ok_button_";
				this->ok_button_->Size = System::Drawing::Size(228, 62);
				this->ok_button_->TabIndex = 8;
				this->ok_button_->Text = L"OK";
				this->ok_button_->UseVisualStyleBackColor = false;
				this->ok_button_->Click += gcnew System::EventHandler(this, &NewUserForm::OkButtonOnClick);
				// 
				// NewUserForm
				// 
